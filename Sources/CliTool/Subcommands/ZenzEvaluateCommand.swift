...
extension Subcommands {
    struct ZenzEvaluate: AsyncParsableCommand {
        ...
        @Option(name: [.customLong("gpulayers")], help: "Number of GPU layers")
        var gpuLayers: Int32 = 10
        ...
        mutating func run() async throws {
            ...
            guard let zenz = await converter.getModel(modelURL: URL(string: self.zenzWeightPath)!, gpuLayers: self.gpuLayers) else {
