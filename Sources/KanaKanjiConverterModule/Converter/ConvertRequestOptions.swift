...
public struct ConvertRequestOptions: Sendable {
    ...
    public struct ZenzaiMode: Sendable, Equatable {
        ...
        public static func on(weight: URL, inferenceLimit: Int = 10, gpuLayers: Int32 = 0, requestRichCandidates: Bool = false, personalizationMode: PersonalizationMode?, versionDependentMode: ZenzaiVersionDependentMode = .v3(.init())) -> Self {
            ZenzaiMode(
                enabled: true,
                weightURL: weight,
